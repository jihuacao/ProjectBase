function(opencv_target)
    ...
    set(${module}_url https://github.com/opencv/opencv.git)
    set(${module}_supported_version 4.4.0)
    set(${module}_supported_tag 4.4.0)
    version_selector(${module} ${module}_supported_version 4.4.0)
    ...
    function(fix_opencv_target_name)
    endfunction(fix_opencv_target_name)

    function(download_and_build_opencv)
    endfunction(download_and_build_opencv)

    if(${${module}_FOUND})
        message(STATUS "${module} Found for  ${${module}_version}")
        fix_opencv_target_name()
        set(${module}_target_name opencv::libopencv CACHE INTERNAL "module target name")
        set(${module}_target_name-lite opencv::libopencv-lite CACHE INTERNAL "module target name")
    else()
        ...
        ExternalProject_Add(
            ...
            CMAKE_CACHE_ARGS
                -Dopencv_WITH_ZLIB:BOOL=ON
                -Dopencv_BUILD_EXAMPLES:BOOL=ON
                -Dopencv_BUILD_TESTS:BOOL=OFF
                -Dopencv_INSTALL_EXAMPLES:BOOl=OFF
        )
