...
set(module OpenCL)
set(${module}_target_name opencl)
set(${module}_supported_version 1.2)
version_selector(${module} ${module}_supported_version 1.2)
...
if(${${module}_FOUND})
    ...
    set_property(TARGET opencl PROPERTY	INTERFACE_INCLUDE_DIRECTORIES ${OpenCL_INCLUDE_DIRS})
    set_property(TARGET opencl PROPERTY INTERFACE_LINK_LIBRARIES ${OpenCL_LIBRARY})
